...
const EFFECT_PRESETS = [
  ...
  {
    id: 'eff-tulips', name: 'Tulip Tops', slug: 'tulips', builtIn: true, enabled: true, frontendSelectable: true,
    version: 1, renderer: 'canvas-particles', description: 'Tulips drifting down in random tulip colours \u2014 kept upright (no spin), each shape\'s quantity independently adjustable.',
    assets: [
      { assetId: 'tulip-1', weight: 20 }, { assetId: 'tulip-2', weight: 20 },
      { assetId: 'tulip-3', weight: 18 }, { assetId: 'tulip-4', weight: 18 },
      { assetId: 'tulip-5', weight: 12 }, { assetId: 'tulip-6', weight: 8 },
      { assetId: 'tulip-7', weight: 12 },
    ],
    // rotation pinned to 0 (min=max, no spin) so every tulip falls exactly as
    // drawn; symmetric drift (-16..16) sends them left AND right across screen.
    motion: { directionDegrees: 180, speedMin: 16, speedMax: 40, driftMin: -16, driftMax: 16, sway: 0.6, rotationMin: 0, rotationMax: 0, rotationSpeedMin: 0, rotationSpeedMax: 0, lifetimeMin: 8, lifetimeMax: 16 },
    emission: { density: 1.1, spawnRate: 1, maxParticlesDesktop: 40, maxParticlesMobile: 18, spawnArea: 'top', burstOnLoad: false, burstCount: 0 },
    appearance: {
      sizeMin: 20, sizeMax: 46, opacityMin: 0.8, opacityMax: 1,
      colorMode: 'palette', colors: ['#E8447A', '#F04E98', '#D81E5B', '#C0392B', '#F6A623', '#F5D547', '#8E44AD', '#B5539C', '#FF7A5C', '#FBEEE6'],
      renderMode: 'fill', fillPercentage: 100, strokePercentage: 0, mixedPercentage: 0,
      strokeWidthMin: 1.5, strokeWidthMax: 2, glowEnabled: false, glowColorMode: 'inherit', glowColors: [], glowBlurMin: 2, glowBlurMax: 5, glowOpacity: 0.4, glowPercentage: 0,
    },
    randomness: { amount: 0.6, assetRandomness: 1, colorRandomness: 1, sizeRandomness: 0.9, speedRandomness: 0.7, opacityRandomness: 0.4, rotationRandomness: 0 },
    accessibility: { reducedMotionMode: 'static-glow' },
  },
  {
...
const SEASONAL_EFFECT_IDS = {
  ...
  easter: 'eff-petals', anzac: 'eff-petals', mothersday: 'eff-petals', floriade: 'eff-tulips',
